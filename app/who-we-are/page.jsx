...
const page = () => {
  return (
    <section className="mb-48  w-full h-full">
      <div className="w-full flex flex-col-reverse md:flex-row bg-yellow justify-center items-center h-full md:h-screen px-4 py-8 sm:px-6 sm:py-12 lg:px-32 lg:py-36 ">
        {/* Text */}
