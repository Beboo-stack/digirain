...
const OurVision = () => {
  return (
    <div
      id="our-vision"
      className="flex flex-col w-full h-full justify-center items-center overflow-hidden mt-[50px0] px-4 py-8 sm:px-6 sm:py-12 lg:px-32 lg:py-36"
    >
      <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-5xl text-yellow font-bold mb-5">Our Vision</h1>
        <h2 className="text-2xl font-bold w-3/4">
      ...
      <p className="mt-10 text-2xl text-center w-3/4">
